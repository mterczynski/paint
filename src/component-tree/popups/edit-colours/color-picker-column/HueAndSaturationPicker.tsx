...
export const HueAndSaturationPicker = () => {
	...
	const [activeMouseMoveListener, setActiveMouseMoveListener] = useState<React.MouseEventHandler<HTMLImageElement> | undefined>(undefined);
	...
	return <div style={{
		...
		<Crosshair position={{x: crosshairPosition.x, y: crosshairPosition.y}}/>
		<img
			ref={imageRef}
			width='100%'
			height='100%'
