	...
	return <div className='Size'>
		...
		<Dropdown provider={Dropdowns.size}>
			<ul className='Size__list'>
				<li className='Size__li' onClick={() => dispatchSetToolSize(ToolSize.one)}>Size 1px</li>
				<li className='Size__li' onClick={() => dispatchSetToolSize(ToolSize.two)}>Size 2px</li>
				<li className='Size__li' onClick={() => dispatchSetToolSize(ToolSize.three)}>Size 3px</li>
				<li className='Size__li' onClick={() => dispatchSetToolSize(ToolSize.four)}>Size 4px</li>
			</ul>
		</Dropdown>
	</div>;
};
