		...
		>
			<div className="ViewTab__content" style={{ justifyContent: "center" }}>
				<ul className="ViewTab__list">
					<li>
						<Checkbox description={lang.rulers.title} />
					</li>
					<li>
						<Checkbox description={lang.gridlines.title} />
					</li>
					<li>
						<Checkbox
							checked={isBottomBarVisible}
							onChange={dispatchToggleBottomBar}
							description={lang.statusBar.title}
						/>
					</li>
				</ul>
			</div>
